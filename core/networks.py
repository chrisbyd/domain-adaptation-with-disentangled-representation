...
class DomainDiscriminator(nn.Module):
    # a domain discriminator which outputs the domain label
    def __init__(self, gantype = 'lsgan'):
...
class Generator(nn.Module):
    ...
    def encode(self, images, togray=False):
        ...
        content, feature_vector, _ = self.mod_invar_enc(images, togray=togray, sl_enc=False)
        style_fake, predict = self.mod_spec_enc(images)

        return content, style_fake, predict, feature_vector
