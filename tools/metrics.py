...
import numpy as np
import os
from tools.reranking import re_ranking,re_ranking_numpy
...
def eval_func(distmat, q_pids, g_pids, q_camids, g_camids, max_rank=50,dataset_name = 'veri'):
    ...
    if dataset_name == 'veri':
        ...
        raise NotImplementedError("the evaluation function is not implemented")


class R1_mAP_eval():
    def __init__(self, num_query, max_rank=50, feat_norm=True, reranking=False,eval_dataset_name = 'eval'):
    ...
    def compute(self):  # called after each epoch
        ...
        cmc, mAP = eval_func(distmat, q_pids, g_pids, q_camids, g_camids, self.max_rank,self.eval_dataset_name)
